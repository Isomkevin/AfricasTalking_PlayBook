# Node.js Voice Integration (Alternative) with Africa's Talking

This guide details how to build a voice call app using Node.js and Africa's Talking API (alternative structure).
...
cd AfricasTalking_PlayBook/voice/nodejs-voice2
```
