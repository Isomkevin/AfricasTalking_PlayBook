    ...
    try:
                ...
                if text == '1':
                    ...
                    if verify_pin(phone_number, pin_input):
                        ...
                        if session_data.get('pin_attempts', 0) >= 3:
                            ...
                            response = f"CON Incorrect PIN. Try again ({3 - session_data.get('pin_attempts', 0)} attempts left)"
            else:
                ...
                if len(parts) == 3:  # Recipient entered
                    ...
                    if session_data.get('otp') and parts[4] == session_data.get('otp'):
                        ...
                        if recipient and amount:
                            ...
                            response = "END Transfer information missing. Please try again."
                    else:
                        response = "END Invalid OTP. Transfer cancelled."
                else:
                    response = "CON Money Transfer\n"
                    response += "Please follow the prompts to complete your transfer."
        ...
        # Transaction History
            ...
            if not session_data.get('authenticated', False):
                ...
                response = "CON Transaction History feature is being accessed"
